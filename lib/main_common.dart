...
import 'package:patta/ui/common/error_boundary.dart';
...
Future<void> mainCommon(Environment environment) async {
  ...
  AppLogger.info('App initialized with environment: ${environment.runtimeType}');

  initFirstRun();
  AppLogger.info('App initialization complete');
  runApp(ErrorBoundary(child: PariyattiApp(environment, configReader)));
}
